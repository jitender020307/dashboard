...
interface DigitalEvidenceVaultViewProps {
  ...
  onSimulateUnauthorizedDownload: (item: EvidenceItem) => void;
}
...
export const DigitalEvidenceVaultView: React.FC<DigitalEvidenceVaultViewProps> = ({
  ...
  onSimulateTamper,
  onRestoreEvidence,
  onSimulateUnauthorizedDownload,
}) => {
                  ...
                  <div className="flex items-center gap-1.5">
                    {!isTampered ? (
                      <button
                        ...
                        title="Demo: Simulate File Tampering"
                        className="px-2.5 py-1.5 rounded-lg bg-white hover:bg-rose-50 text-rose-700 text-xs font-medium flex items-center gap-1 border border-rose-200 transition-colors cursor-pointer shadow-2xs"
                      >
                    ...
                    <button
                      onClick={() => onSimulateUnauthorizedDownload(ev)}
